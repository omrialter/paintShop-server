...
exports.validatePurchase = (_reqBody) => {
    ...
    let joiSchema = Joi.object({
        ...
        street_address: Joi.string().min(3).max(100).required(),
        apartment_number: Joi.string().min(1).max(50).allow('', null), // Allow empty or null for cases without apartment numbers
